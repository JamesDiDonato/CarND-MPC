...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    //Bump indicies by 1 since fg[0] reserved for cost
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // Only variables that need constraining are the actuators
  // delta [-25deg, 25deg]
  // a [-1 , 1]
  // All other variables, set bounds to maximum integers
  //
  ...
  //return commands for the next time step:
